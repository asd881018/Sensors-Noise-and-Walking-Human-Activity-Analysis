...
def main():
    ...
    s_down_2_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_3_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_4_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_5_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_6_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_7_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_8_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_9_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
    s_down_10_bw.to_csv('processed_data/srp_down_1_bw.csv', index=False)
